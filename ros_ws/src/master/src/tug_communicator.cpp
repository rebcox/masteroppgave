...
namespace Tug
{
 ...
 /* Tug::Point tug1_location(0.0*scale,0.0*scale, environment);
  Tug::Boat tug1(1, tug1_location , &environment);

  Tug::Point tug2_location(2.0*scale, 0.0*scale, environment);
  Tug::Boat tug2(1, tug2_location , &environment);
